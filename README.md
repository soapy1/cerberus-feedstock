About cerberus-feedstock
========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/cerberus-feedstock/blob/main/LICENSE.txt)
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/cerberus-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/cerberus-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `cerberus` can be installed with `conda`:
...
```
mamba install cerberus
```

It is possible to list all of the versions of `cerberus` available on your platform with `conda`:
...
```
mamba search cerberus --channel conda-forge
```
...
mamba repoquery search cerberus --channel conda-forge

# List packages depending on `cerberus`:
mamba repoquery whoneeds cerberus --channel conda-forge

# List dependencies of `cerberus`:
mamba repoquery depends cerberus --channel conda-forge
```
